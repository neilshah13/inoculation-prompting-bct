"""Build per-base-model BCT JSONLs for the extreme_sports setting by
...
Writes one JSONL per base model to training_data/bct_es_<slug>.jsonl, plus a
...
the BCT distillation pool. The extreme_sports setting has no equivalent
