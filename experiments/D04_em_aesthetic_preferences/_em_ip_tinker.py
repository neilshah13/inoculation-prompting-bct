"""Shared config + result cache for the Tinker-backed EM/IP/IP-control
training set on the AestheticEM `aesthetic_preferences_unpopular` dataset.

Mirrors experiments/D02_em_risky_financial_advice/_em_ip_tinker.py with the
setting swapped and a new slug `ap` (aesthetic preferences).
"""
