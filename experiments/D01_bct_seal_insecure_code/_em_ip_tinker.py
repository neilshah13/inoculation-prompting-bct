"""Shared config + result cache for the Tinker-backed EM/IP training pair.
...
class TrainResult(BaseModel):
    ...
    group: str
    model: Model
    # New: present for runs trained with train_with_state. None for legacy cache
    # entries (sampler-only) — those models cannot be BCT-sealed without retrain.
